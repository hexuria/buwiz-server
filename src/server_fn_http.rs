...
use crate::app::{
    ...
    CloneProfileYear, CompleteEmailVerification, CompleteOauthCallback, CompletePasswordReset,
    ...
    GetProfileYear, GetPublicProfile, GetWorkspaceSettingsContext, InviteCurrentOrganizationMember,
    ...
    ListProfileYears, ListSigningKeys, ListTaxProfiles, ListWorkspaceAudit, ListWorkspaceInvitations,
    ...
    SaveProfileYear, SetYearForms,
    SaveDashboardLayout, SaveRedirectAllowlist, SeedDashboardDemos, SelectOrganization,
    SkipDevelopmentEmailVerification, StartOauthLogin, StartPasskeyLogin,
    StartPasskeyRegistration, StartPasswordReset,
...
async fn dispatch(
    ...
    try_fn!(
        ...
        SkipDevelopmentEmailVerification,
